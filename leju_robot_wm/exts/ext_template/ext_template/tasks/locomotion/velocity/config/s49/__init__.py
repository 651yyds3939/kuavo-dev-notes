...
# TD-MPC2 world-model training (S49 dance)
gym.register(
    id="Legged-Isaac-Velocity-Flat-Kuavo-S49-Punch-TDMPC2-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.punch_env_cfg:KuavoS49PunchEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:KuavoS49FlatPPORunnerCfg",
        "tdmpc2_cfg_entry_point": f"{agents.__name__}.tdmpc2_cfg:KuavoS49TDMPC2RunnerCfg",
    },
)

gym.register(
    id="Legged-Isaac-Velocity-Flat-Kuavo-S49-Punch-TDMPC2-Play-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.punch_env_cfg:KuavoS49PunchEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:KuavoS49FlatPPORunnerCfg",
        "tdmpc2_cfg_entry_point": f"{agents.__name__}.tdmpc2_cfg:KuavoS49TDMPC2PlayRunnerCfg",
    },
)
