...
- 启动VR节点
  ...
  - 参考[参考机器人VR控制教程](https://kuavo.lejurobot.com/beta_manual/basic_usage/kuavo-ros-control/docs/2快速开始/快速开始/)
  ...
  - 参考[灵巧手手势使用案例](../通用案例/11.灵巧手手势使用案例3.md)
- 同时启动VR节点和机器人
  - 运行
  ```bash
  sudo su
...
- 低延迟模式  
  ...
  > 参考[有线vr使用教程](https://kuavo.lejurobot.com/beta_manual/basic_usage/kuavo-ros-control/docs/6常用工具/有线VR方案使用指南/)，**注意网线和vr的转接线头如果是usb口的话必须使用usb3.0的转接口，否则路由器可能会识别不到VR设备**，随后在路由器的后台查看VR设备的ip地址
