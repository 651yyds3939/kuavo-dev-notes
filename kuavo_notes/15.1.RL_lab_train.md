> 👉 **通用专题（robotics-notes）**：[RL 理论](https://github.com/651yyds3939/robotics-notes/blob/master/robotics/RL.md) · [边缘部署 ONNX](https://github.com/651yyds3939/robotics-notes/blob/master/robotics/edge_deployment.md) · [机器人建模 URDF](https://github.com/651yyds3939/robotics-notes/blob/master/robotics/robot_modeling.md) · [全链路导图](https://github.com/651yyds3939/robotics-notes/blob/master/robot_system.md)
...
python3 scripts/rsl_rl/train.py --task Legged-Isaac-Velocity-Flat-Kuavo-Punch-v0 --num_envs 256 --headless --video


python scripts/rsl_rl/play.py --task Legged-Isaac-Velocity-Flat-Kuavo-Punch-v0 --load_run 2026-06-13_04-59-23 --checkpoint model_9000.pt --num_envs 256 --headless --video --video_length 400
```
