...
echo "==> [2/3] LAFAN1 G1 dance CSV batch convert (60s clip, 50Hz, kuavo_dance profile)"
bash scripts/tools/batch_convert_lafan1_g1_dance.sh

echo "==> [3/3] Clean stale USD cache + start training"
rm -rf /tmp/IsaacLab/usd_*

echo "Training CSV : kuavo_action_LAFAN1_g1_dance1_DANCE_RAD.csv"
echo "num_envs       : ${NUM_ENVS}"
echo "Reward profile : 防跪 v2 + 防勾脚 v3 + 舞感增强 v4"
